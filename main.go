/*
    ...
    Git: https://github.com/wildy281/ProxyChecker.git

    This project is licensed under the GNU Public License V3.
    
    (C) Copyright 2023 - Wildy Sheverando [ Wildy281 ]
*/
...
func checkProxy(proxy Proxy, wg *sync.WaitGroup, errChan chan error, activeFile *os.File, activeMap map[string]bool) {
	...
	resp, err := client.Get("https://raw.githubusercontent.com/wildy283/TestConnection/main/test.txt")
	if err != nil {
		resp, err = client.Get("https://raw.githubusercontent.com/wildy283/TestConnection/main/test.txt")
	}
	if err != nil {
